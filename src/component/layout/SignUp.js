        ...
        <div className='h-4/6 w-full sm:w-8/12 lg:w-1/2 p-4 border-2 border-[#0000001a] rounded-xl mb-4'>
          ...
          <div className='flex justify-center items-center'>
            <div className='loginPage w-full p-2 rounded-2xl'>
              ...
              {status === 'failed' && <p className='text-red-500 text-center text-lg font-semibold'>Error: {error?.message}</p>}
            </div>
          </div>

          <h2 className='text-sm text-center mt-4'>By continuing you indicate that you read and agreed to the Terms of Use</h2>
          {status === 'succeeded' && <p className='text-green-500 text-xl text-center p-2 font-bold'>User created but not confirmed. Please check your email and confirm your account within 5 minutes.</p>}
        </div>
      </div>
    </Fragment>
  );
