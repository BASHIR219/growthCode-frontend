...
export const createUser = createAsyncThunk(
  ...
  export const updateUserRole = createAsyncThunk(
    ...
    async ({ id, role }, thunkAPI) => {
      try {
        const response = await axios.put(`http://localhost:4000/api/v1/admin/user/${id}`, { role },{
          withCredentials:true
        });
        return response.data;
      } catch (error) {
  ...
  export const deleteUser = createAsyncThunk(
    ...
    async (id, thunkAPI) => {
      try {
        const response = await axios.delete(`http://localhost:4000/api/v1/admin/user/${id}`,{
          withCredentials:true
        });
        return response.data;
      } catch (error) {
