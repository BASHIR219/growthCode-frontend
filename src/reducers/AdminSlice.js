...
export const fetchAdminProduct = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      ...
      const response = await axios.get('http://localhost:4000/api/v1/admin/products',
        {
...
export const fetchAdminOrder = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      ...
      const response = await axios.get('http://localhost:4000/api/v1/admin/orders',
        {
          withCredentials: true
        }
      );
...
export const deleteOrder = createAsyncThunk(
  ...
  async (orderId, thunkAPI) => {
    try {
      ...
      const response = await axios.delete(`http://localhost:4000/api/v1/admin/order/${orderId}`,
        {
          withCredentials: true
        }
      );
